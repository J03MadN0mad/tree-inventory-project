...
**NOTE: team currently only has 1 unit. If your team can procure multiple units, it is up to the project lead to determine if the standalone GNSS unit will be used entirely or used like our supplemental use case.**
